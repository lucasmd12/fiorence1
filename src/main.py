...
# from routes.upload import upload_bp  # <-- PASSO 1: COMENTE ESTA LINHA
...
# app.register_blueprint(upload_bp, url_prefix='/api') # <-- PASSO 2: COMENTE ESTA LINHA TAMBÉM
...
app.register_blueprint(reports_export_bp, url_prefix='/api')
...
def health_check():
    """Rota leve para manter o serviço ativo."""
